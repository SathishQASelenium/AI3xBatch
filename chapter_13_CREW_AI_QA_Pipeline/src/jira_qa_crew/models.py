...
class CoverageReport(BaseModel):
    ...
    #: Whether the generated automation can run as-is. Deliberately separate
    #: from coverage: "is this requirement tested?" and "does the script have
    #: the selectors it needs?" are different questions, and folding the second
    #: into the first made automating a requirement lower its coverage score.
    automation_execution_ready: bool = True
    #: What the automation still needs before it can run, when not ready.
